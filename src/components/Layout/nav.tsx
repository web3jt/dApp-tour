    ...
    return (
        <li>
            ...
            >
                {children}
                {isActive && (
                    <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-pri-500/0 via-pri-500/40 to-pri-500/0 dark:from-pri-400/0 dark:via-pri-400/40 dark:to-pri-400/0" />
                )}
            </Link>
        </li>
    );
